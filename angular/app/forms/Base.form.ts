//bazowa klasa tutaj lądują funkcjonalności które są używane we wszystkich formularzy, jeżeli mamy jakis specyficzny case
//to pakujemy do klasy rozszerzającej, nie zasmiecać
